...
public class Adminmodifylibrarian 
{
	...
	public Adminmodifylibrarian()
	{
		...
		emailID.setBounds(350,340,170,30);
		...
		b1.addActionListener(new ActionListener()
		{
	        ...
	        {
	        	Connection conn=Connectiondemo.getConnection();
	        	PreparedStatement ps=conn.prepareStatement("update addlibrarian set userID='"+userid1+"',password='"+password1+"',name='"+name1+"',emailID='"+email1+"',address='"+address1+"',city='"+city1+"',contact='"+contact1+"' where userid='"+userid1+"'");  
	        	ps.executeUpdate();
